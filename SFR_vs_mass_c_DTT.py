...
class SFRVsMassCDTT:
    ...
    def __init__(self, simulation_path, tag):
        ...
        self.plot(disc_fractions_IT20, stellar_masses, glx_star_formation_rates)
        print('Plotted data for ' + re.split('Planck1/|/PE', simulation_path)[1] + ' in %.4s s' % (time.time() - start_local_time))
        print('–––––––––––––––––––––––––––––––––––––––––––––')
        
        print('Finished SFR_V_M_C_DTT for ' + re.split('Planck1/|/PE', simulation_path)[1] + ' in %.4s s' % (time.time() - start_global_time))
        print('–––––––––––––––––––––––––––––––––––––––––––––')
    ...
    def plot(self, disc_fractions_IT20, stellar_masses, glx_star_formation_rates):
        ...
        x_value, median, shigh, slow = plot_tools.median_1sigma(stellar_masses[glx_star_formation_rates > 0],
        ...
        # Save the plot #
        plt.savefig(plots_path + 'SFR_V_M_C_DTT' + '-' + date + '.png', bbox_inches='tight')
        return None
...
if __name__ == '__main__':
    ...
    x = SFRVsMassCDTT(simulation_path, tag)

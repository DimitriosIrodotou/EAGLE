...
class MultipleDecomposition:
    ...
    def __init__(self, simulation_path, tag):
        ...
        for group_number in range(125, 126):  # Loop over all masked haloes.
    ...
    def plot(stellar_data_tmp, group_number, subgroup_number):
        ...
        ax11.hexbin(angular_theta_from_densest[density_map.nonzero()] * np.divide(180.0, np.pi), density_map[density_map.nonzero()],mincnt=1,bins='log',cmap='Spectral_r')#, c='black',s=5)  # In degrees.

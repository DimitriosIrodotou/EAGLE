...
class DTTVsEnvironment:
    ...
    def plot(group_numbers, subgroup_numbers, glx_stellar_masses, glx_disc_fractions_IT20, glx_stellar_angular_momenta, glx_gaseous_angular_momenta,
        ...
        gaseous stellar and components and disc and bulge.
        ...
        axis01, axis02 = figure.add_subplot(gs[0, 1]), figure.add_subplot(gs[0, 2])
        axis10, axis11, axis12, axis13 = figure.add_subplot(gs[1, 0]), figure.add_subplot(gs[1, 1]), figure.add_subplot(gs[1, 2]), figure.add_subplot(
            gs[1, 3])
        plot_tools.set_axis(axis10, ylim=[0, 1], aspect=None, which='major')
        plot_tools.set_axis(axis11, xlim=[-1.1, 1.1], ylim=[0, 1], aspect=None, which='major')
        plot_tools.set_axis(axis12, xlim=[-1.1, 1.1], ylim=[0, 1], aspect=None, which='major')

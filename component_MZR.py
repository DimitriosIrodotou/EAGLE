...
class ComponentMZR:
    ...
    def __init__(self, simulation_path, tag):
        ...
        print('Finished ComponentMZR for ' + re.split('Planck1/|/PE', simulation_path)[1] + '_' + str(tag) + ' in %.4s s' % (
            time.time() - start_global_time))
        print('–––––––––––––––––––––––––––––––––––––––––––––')
    
    
    @staticmethod
    def plot(stellar_masses, disc_metallicities, bulge_metallicities, glx_disc_fractions_IT20):
        """

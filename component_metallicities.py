...
class ComponentMetallicities:
    """
    For all galaxies create: a disc and bulge metallicity plot.
    """
    ...
    def __init__(self, simulation_path, tag):
        ...
        print('Finished CM for ' + re.split('Planck1/|/PE', simulation_path)[1] + ' in %.4s s' % (time.time() - start_global_time))
        print('–––––––––––––––––––––––––––––––––––––––––––––')
    
    
    def plot(self, disc_fractions_IT20, stellar_masses, disc_metallicities, bulge_metallicities):
        """
        Plot the disc and bulge metallicity.
        ...
        # Save the plot #
        plt.savefig(plots_path + 'CM' + '-' + date + '.png', bbox_inches='tight')
        return None
...
if __name__ == '__main__':
    ...
    x = ComponentMetallicities(simulation_path, tag)

...
class TullyFisherFaberJackson:
    ...
    def plot(glx_stellar_masses, glx_rotationals, disc_rotationals, bulge_rotationals, glx_sigma_0s, disc_sigma_0s, bulge_sigma_0s,
        ...
        axis20.scatter(np.log10(GMF20_RR['Vrot']), GMF20_RR['Mstar'], color='cyan', zorder=2, label=r'$\mathrm{Girard+20:\;u_{rot}/\sigma<3}$')
        axis20.scatter(np.log10(GMF20_IR['Vrot']), GMF20_IR['Mstar'], color='cyan', marker='^', zorder=2, label=r'$\mathrm{Girard+20:\;1<u_{rot}/\sigma<3}$')

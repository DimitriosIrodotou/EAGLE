...
class BulgeToTotalAngularMomentum:
    """
    For all galaxies create: a bulge to total ratio as a function of normalised specific galactic angular momentum plot.
    """
    ...
    def plot(self, glx_stellar_masses, glx_disc_fractions_IT20, glx_stellar_angular_momenta):
        """
        Plot bulge to total ratio as a function of normalised specific galactic angular momentum.
        ...
        plot_tools.set_axis(axis, xlim=[-5, -3], ylim=[0, 1],
        ...
        axis.scatter(np.log10(spc_stellar_angular_momenta[mask]), 1 - glx_disc_fractions_IT20[mask])

...
class DiscToTotalCRVsMorphologicalParameters:
    ...
    def __init__(self, simulation_path, tag):
        ...
        # i, = np.where(glx_disc_fractions_IT20_cr[glx_disc_fractions_IT20_cr > 2 * glx_disc_fractions_IT20] - glx_disc_fractions_IT20[
        #     glx_disc_fractions_IT20_cr > 2 * glx_disc_fractions_IT20] == max(
        #     glx_disc_fractions_IT20_cr[glx_disc_fractions_IT20_cr > 2 * glx_disc_fractions_IT20] - glx_disc_fractions_IT20[
        #         glx_disc_fractions_IT20_cr > 2 * glx_disc_fractions_IT20]))
        # print(glx_group_numbers[i])
        # print(glx_subgroup_numbers[i])
        # print(glx_disc_fractions_IT20_cr[i])
        # print(glx_disc_fractions_IT20[i])
        print(max(glx_disc_fractions_IT20_cr[glx_disc_fractions_IT20_cr > 2 * glx_disc_fractions_IT20] / glx_disc_fractions_IT20[
            glx_disc_fractions_IT20_cr > 2 * glx_disc_fractions_IT20]))

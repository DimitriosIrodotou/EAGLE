...
class SFRVsAngularMomentum:
    ...
    def __init__(self, simulation_path, tag):
        ...
        self.plot(stellar_masses, glx_disc_fractions_IT20, star_formation_rates, stellar_angular_momenta)
    ...
    @staticmethod
    def plot(stellar_masses, glx_disc_fractions_IT20, star_formation_rates, stellar_angular_momenta):
        """

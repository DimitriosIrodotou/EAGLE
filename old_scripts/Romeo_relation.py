...
class RomeoRelation:
    ...
    def __init__(self, simulation_path, tag):
        ...
        self.plot(stellar_masses, glx_disc_fractions_IT20, glx_star_formation_rates, stellar_angular_momenta)
        print('Plotted data for ' + re.split('Planck1/|/PE', simulation_path)[1] + ' in %.4s s' % (time.time() - start_local_time))
        print('–––––––––––––––––––––––––––––––––––––––––––––')
        
        print('Finished RomeoRelation for ' + re.split('Planck1/|/PE', simulation_path)[1] + '_' + str(tag) + ' in %.4s s' % (time.time() - start_global_time))
        print('–––––––––––––––––––––––––––––––––––––––––––––')
    
    
    def plot(self, stellar_masses, glx_disc_fractions_IT20, glx_star_formation_rates, stellar_angular_momenta):
        """
        ...
        spc_star_formation_rates = glx_star_formation_rates / stellar_masses
        sc = axis10.scatter(np.log10(spc_angular_momenta[spc_star_formation_rates > 0]),
                          np.log10(spc_star_formation_rates[spc_star_formation_rates > 0]), c=glx_disc_fractions_IT20[spc_star_formation_rates > 0], s=8,
